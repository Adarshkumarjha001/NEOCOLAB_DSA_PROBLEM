...
int main() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            std::cout << name << " has been added to the waitlist." << std::endl;
        } else if (choice == 2) {
            if (waitlist.empty()) {
            ...
            if (waitlist.empty()) {
                ...
                std::string customer = waitlist.front();
                waitlist.pop_front();
                waitlist.push_back(customer);
                std::cout << customer << " has been moved to the back of the waitlist." << std::endl;
            }
        } else if (choice == 4) {
            if (waitlist.empty()) {
